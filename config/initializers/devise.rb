...
Devise.setup do |config|
  config.warden do |manager|
    manager.default_strategies(:scope => :fae_user).unshift :two_factor_authenticatable
  end
  ...
  # is failed attempts.
  # Note, this was increased to 10 because devise two factor checks it twice, so every failed
  # login attemp counts as two failed attemps.
  # Issue https://github.com/devise-two-factor/devise-two-factor/issues/127
