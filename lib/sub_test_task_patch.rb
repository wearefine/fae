# @deprecation - Rails::TestTask was deprecated in Rails 5, but this class is required to run Travis tests in Rails 4
# can deprecate when we drop Rails 4 support
