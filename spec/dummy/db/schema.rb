...
ActiveRecord::Schema[7.0].define(version: 2023_09_13_192940) do
  ...
  create_table "acclaims", id: :serial, force: :cascade do |t|
    t.string "score"
  ...
  create_table "aromas", id: :serial, force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "position"
    t.boolean "live"
  ...
  create_table "event_releases", id: :serial, force: :cascade do |t|
    t.integer "release_id"
    t.integer "event_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "jerseys", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "color"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "release_selling_points", id: :serial, force: :cascade do |t|
    t.integer "release_id"
  ...
  create_table "selling_points", id: :serial, force: :cascade do |t|
    t.string "name"
    t.boolean "on_stage", default: true
    t.boolean "on_prod", default: false
    t.integer "position"
  ...
  create_table "spirit_categories", force: :cascade do |t|
    t.string "name"
    t.string "slug"
    t.boolean "published"
    t.datetime "created_at", null: false
    ...
    t.index ["published"], name: "index_spirit_categories_on_published"
    t.index ["slug"], name: "index_spirit_categories_on_slug"
    t.index ["status"], name: "index_spirit_categories_on_status"
  end
  ...
  create_table "validation_testers", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "slug"
  ...
  create_table "varietals", id: :serial, force: :cascade do |t|
    t.string "name"
    t.boolean "on_stage", default: true
    t.boolean "on_prod", default: false
    t.integer "position"
  ...
  create_table "winemakers", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "position"
    t.integer "wine_id"
    t.datetime "created_at", precision: nil, null: false
