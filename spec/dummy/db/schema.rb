...
ActiveRecord::Schema[7.0].define(version: 2023_01_11_150220) do
  ...
  create_table "fae_deploys", charset: "utf8mb3", force: :cascade do |t|
    t.integer "user_id"
    t.string "user_name"
    t.string "external_deploy_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["external_deploy_id"], name: "index_fae_deploys_on_external_deploy_id"
