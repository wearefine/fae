...
ActiveRecord::Schema[7.0].define(version: 2023_07_21_164041) do
  ...
  create_table "aromas", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "position"
    t.boolean "live"
  ...
  create_table "beers", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "seo_title"
  ...
  create_table "cats", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.boolean "friendly"
    t.text "description"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "coaches", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "role"
    t.text "bio"
  ...
  create_table "event_releases", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "release_id"
    t.integer "event_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "fae_changes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "fae_images", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "asset"
  ...
  create_table "fae_roles", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.integer "position"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "fae_text_areas", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "label"
    t.text "content"
    t.integer "position", default: 0
    t.boolean "on_stage", default: true
  ...
  create_table "fae_text_fields", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "contentable_type"
    t.integer "contentable_id"
    t.string "attached_as"
    t.string "label"
  ...
  create_table "fae_users", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "gidgits", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "jerseys", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "color"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "poly_things", force: :cascade do |t|
    t.string "name"
  ...
  create_table "release_selling_points", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "release_id"
  ...
  create_table "releases", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "slug"
    t.text "intro"
    t.text "body"
  ...
  create_table "selling_points", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.boolean "on_stage", default: true
    t.boolean "on_prod", default: false
    t.integer "position"
  ...
  create_table "sub_aromas", force: :cascade do |t|
    t.string "name"
    t.integer "aroma_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "validation_testers", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "slug"
  ...
  create_table "varietals", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.boolean "on_stage", default: true
    t.boolean "on_prod", default: false
    t.integer "position"
  ...
  create_table "winemakers", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.integer "position"
    t.integer "wine_id"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "wines", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name_en"
    t.boolean "on_stage", default: true
    t.boolean "on_prod", default: false
    t.integer "position"
