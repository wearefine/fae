module Fae
  module  ViewHelper
    ...
    def fae_content_form(f, attribute, label: nil, hint: nil, helper_text: nil, markdown: nil, markdown_supported: nil, wrapper_html: nil, input_options: nil)
      render 'fae/application/content_form', f: f, attribute: attribute, label: label, hint: hint, helper_text: helper_text, markdown: markdown, markdown_supported: markdown_supported, wrapper_html: wrapper_html, input_options: input_options
    end
