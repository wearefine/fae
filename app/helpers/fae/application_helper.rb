module ApplicationHelper
  ...
  # retiring this for a partial
  def states_select(states)
    select_tag :state, options_for_select(states.map { |state| [state.name, state.id] }), class: 'select', prompt: 'Select a State'
  end
