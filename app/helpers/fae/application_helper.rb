module Fae
  module ApplicationHelper
    ...
    def image_form(f, item, image_name: nil, image_label: nil, alt_label: nil, caption_label: nil, omit: nil, show_thumb: nil, required: nil, helper_text: nil, alt_helper_text: nil, caption_helper_text: nil)
