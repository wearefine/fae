module Fae
  class OptionsController < ApplicationController
    ...
    private
      ...
      def option_params
        params.require(:option).permit(:title, :time_zone, :colorway, :stage_url, :live_url, :translate_language, logo_attributes: [:id, :asset, :asset_cache, :attached_as, :alt], favicon_attributes: [:id, :asset, :asset_cache, :attached_as, :alt])
      end
  end
end
